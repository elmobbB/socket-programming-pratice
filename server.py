...
class EchoHandler(BaseRequestHandler):
    ...
    msg_str = ""  # Added instance variable
    ...
    def handle(self):
        ...
        while True:
            ...
            if len(msg_pieces) >= 2:
                self.send_str(self.error_str)#send this error msg back to client!
                    ...
                    if command == 'POST_STRING':
                        ...
                        while in_mail:
                            if file:
                                ...
                                # Here you can change the path to save the file sent by the client
